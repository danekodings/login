                ...
                <ul class="navbar-nav mr-lg-2">
                    ...
                    <li class="nav-item">
                        <div class="d-flex align-items-baseline">
                            ...
                            <i class="typcn typcn-chevron-right"></i>
                            <p class="mb-0">Tambah Sertifikat</p>
                        </div>
                    </li>
                </ul>
                <ul class="navbar-nav navbar-nav-right">
              ...
              <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <form action="<?= base_url('sertifikat/tambah_data')?>" method="POST">
                    <div class="form-group text-body">
                                    <label for="participant_name">Participant Name</label>
                                    <select name="participant_name" class="form-control">
                                ...
                                <div class="form-group text-body">
                                    ...
                                    <select name="event_name" class="form-control">
                                        ...
                                        <?php foreach ($event as $evn) { ?>
                                            <option value="<?= $evn->event_name ?>"><?= $evn->event_name ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="certificate_text" id="certificate_text" placeholder="Masukan Organizer">
                      </div>
